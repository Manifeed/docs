...
| [rss.md](./rss.md) | catalogue RSS et ingest | 6 |
| [sources.md](./sources.md) | lecture sources et embeddings | 5 |
| [jobs.md](./jobs.md) | suivi des jobs | 3 |
...
- Le flag `reembed_model_mismatches` est publie cote HTTP mais n'est pas encore exploite dans la requete SQL courante.
